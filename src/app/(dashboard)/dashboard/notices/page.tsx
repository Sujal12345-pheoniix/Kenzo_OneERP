...
const TARGET_LABELS: Record<string, string> = {
  ...
  JAM_DEVELOPER: "JAM Developers",
  FIELD_SALES: "Field Sales Executives",
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={target} onChange={(e) => setTarget(e.target.value)} className="form-select font-semibold">
                    ...
                    <option value="JAM_DEVELOPER">JAM Developers</option>
                    <option value="FIELD_SALES">Field Sales Executives</option>
